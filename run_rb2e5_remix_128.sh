...
export model_name="OpenPAI-LongContext-17BA3B-32k-ds0714-rb2e5-remix-bs128"
...
CUDA_VISIBLE_DEVICES=0,1 bash run_sigma.sh 1000 &
CUDA_VISIBLE_DEVICES=2,3 bash run_sigma.sh 1200 &
CUDA_VISIBLE_DEVICES=4,5 bash run_sigma.sh 1400 &
